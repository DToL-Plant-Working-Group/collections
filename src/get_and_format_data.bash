...
# create a text file of counties. Sort out these Rust panics.
printf "Getting county names. May take some time.\n"
...
awk -v d="$d" -F ","  'BEGIN {OFS=","} { if ($8 == "yes" || $9 == "yes" || $10 == "yes" || $11 == "yes" || $12 == "yes" || $13 == "yes")  print $1,$2,$3,$3 " "  $4,d}' vascular_${d}.csv > vascular_${d}_collected.csv
