...
d3.json("../data/uk.json").then(function (ukCounties, JSONerror) {
    ...
    d3.json("../data/ireland.json").then(function (irelandCounties, JSONerror) {
        if (JSONerror) return console.warn(JSONerror);
        d3.csv("../data/COPO_parsed_DToL_plant_collections.csv").then(function (data, CSVerror) {
            // return csv of parsed data from R script
            if (CSVerror) return console.warn(CSVerror);
            // need genome size data here.
            d3.csv("../data/parsed_genome_sizes.csv").then(function (genome_sizes, CSVError) {
                if (CSVError) return console.warn(CSVError);
                ...
                const gs_data = genome_sizes.map(function (d) {
                    return {
                ...
                para1
                    ...
                    .call(
                        ...
                        }. A full and updated list of the DToL plant species, priorities, and collections can be found <b><a href="http://bit.ly/DToLbryophytes2021">here</a></b> for bryophytes, and <b><a href="http://bit.ly/DToLplants2021">here</a></b> for vascular plants.`,
                        0.04,
                        0.5
                    );
